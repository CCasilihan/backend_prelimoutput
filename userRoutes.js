...
// Login endpoint
router.post(URL_PREFIX + '/login', async (req, res) => {
    try {
...
// Get users endpoint
router.get(URL_PREFIX + '/users', (req, res) => {
    try {
...
router.put(URL_PREFIX + '/update/:userID', authenticateUser, (req, res) => {
...
router.delete(URL_PREFIX + '/delete/:userId', authenticateUser, async (req, res) => {
    const { userId } = req.params;
...
// Logout endpoint
router.post(URL_PREFIX + '/logout', authenticateUser, (req, res) => {
